    ...
    <div className="planets">
      ...
      <div className="planets-imgs">
        <div className="planets-wrapper">
          <img src={Mercure} id="mercury" data-index="1" onClick={handleData} alt="Mercury" />
          <img src={Venus} id="venus" data-index="2" onClick={handleData} alt="Venus" />
          <img src={Terre} id="earth" data-index="3" onClick={handleData} alt="Earth" />
          <img src={Mars} id="mars" data-index="4" onClick={handleData} alt="Mars" />
          <img src={Jupiter} id="jupiter" data-index="5" onClick={handleData} alt="Jupiter" />
          <img src={Saturne} id="saturn" data-index="6" onClick={handleData} alt="Saturn" />
          <img src={Uranus} id="uranus" data-index="7" onClick={handleData} alt="Uranus" />
          <img src={Neptune} id="neptune" data-index="8" onClick={handleData} alt="Neptune" />
        </div>
      </div>
      ...
      <div className="planets-controls">
        <label htmlFor="radio1" data-index="1" className="clickable-controls" onClick={handleData}></label>
        <label htmlFor="radio2" data-index="2" className="clickable-controls" onClick={handleData}></label>
        <label htmlFor="radio3" data-index="3" className="clickable-controls" onClick={handleData}></label>
        <label htmlFor="radio4" data-index="4" className="clickable-controls" onClick={handleData}></label>
        <label htmlFor="radio5" data-index="5" className="clickable-controls" onClick={handleData}></label>
        <label htmlFor="radio6" data-index="6" className="clickable-controls" onClick={handleData}></label>
        <label htmlFor="radio7" data-index="7" className="clickable-controls" onClick={handleData}></label>
        <label htmlFor="radio8" data-index="8" className="clickable-controls" onClick={handleData}></label>
      </div>
    </div>
  )
}
